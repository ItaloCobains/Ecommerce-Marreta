...
export default function PlaceOrderScreen() {
  ...
  return (
    <Layout title="Faça a encomenda">
      ...
      <h1 className="mb-4 text-xl">Faça a encomenda</h1>
      {cartItems.length === 0 ? (
        <div>
          Carrinho esta vazio. <Link href="/">Vai fazer compras</Link>
        </div>
      ) : (
        <div className="grid md:grid-cols-4 md:gap-5">
          <div className="overflow-x-auto md:col-span-3">
            <div className="card  p-5">
              <h2 className="mb-2 text-lg">Endereço para envio</h2>
              <div>
            ...
            <div className="card overflow-x-auto p-5">
              <h2 className="mb-2 text-lg">Ordem de itens</h2>
            ...
            <div className="card  p-5">
              ...
              <ul>
                ...
                <li>
                  ...
                  >
                    {loading ? "Loading..." : "Faça a encomenda"}
                  </button>
                </li>
              </ul>
            </div>
