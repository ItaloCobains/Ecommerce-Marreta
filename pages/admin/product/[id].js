          ...
          <ul>
            ...
            <li>
              <Link href="/admin/products">
                <a className="font-bold">Produtos</a>
              </Link>
            </li>
            <li>
            ...
            >
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="slug"
                  {...register("slug", {
                    required: "Por favor, insira o slug",
                  })}
                />
                {errors.slug && (
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="image"
                  {...register("image", {
                    required: "Por favor, insira a imagem",
                  })}
                />
                {errors.image && (
              ...
              <div className="mb-4">
                <label htmlFor="imageFile">Upload imagem</label>
                <input
                  type="file"
                  className="w-full"
                  id="imageFile"
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="brand"
                  {...register("brand", {
                    required: "Por favor, insira a marca",
                  })}
                />
                {errors.brand && (
              ...
              <div className="mb-4">
                <label htmlFor="countInStock">Descrição</label>
                <input
                  type="text"
                  className="w-full"
                  id="description"
              ...
              <div className="mb-4">
                <button disabled={loadingUpdate} className="primary-button">
                  {loadingUpdate ? "Loading" : "Atualizar"}
                </button>
              </div>
              <div className="mb-4">
